   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   //first the loop goes through row, second loop goes through column
	   for(int i = 0; i < intArray.length; i++) {
   ...
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for (int i = 0; i < intArray.length; i++) {
		   ...
		   int current = intArray[i][column];
		   
		   if ( mVal == 0 || current < mVal) {
	   ...
	   if(mVal > 0) {
		   ...
		   animate(minRow, column, mVal);
	   }
	   
      return mVal; // replace this line with your return statement
   }
